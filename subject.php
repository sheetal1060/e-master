...
<body>
	...
	?>
	<section id="head" class="secondary">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h1>Add Subject</h1>
	...
	<form method="POST" action="#">
		<table border="0" text-align="center" align="center" class="center">
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><button name="submit" class="btn  btn-primary btn-block">Create Subject</button></td>
			</tr>
			
			<tr>
				<td colspan="2" align="center"><button class="btn btn-primary btn-block">Reset</button></td>
			</tr>
		</table>
	</form>
	<?php
